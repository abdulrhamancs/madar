...
export const AVAILABLE_BADGES = [
  ...
  "لجنة المحتوى العلمي - رئيس",
  "لجنة المحتوى العلمي - نائب",
  "لجنة صناعة المحتوى - رئيس",
  "لجنة صناعة المحتوى - نائب",
  "لجنة الخدمات اللوجستية - رئيس",
  "لجنة الخدمات اللوجستية - نائب",
...
export const translations = {
  ar: {
    ...
    admin_display: "أعضاء للعرض",
    admin_news: "الأخبار",
    admin_points: "النقاط",
    admin_events: "الفعاليات",
    display_member_lead:
      "أعضاء يظهرون في هيكلة النادي وجدول النقاط دون حساب دخول.",
    display_badge: "المنصب (اختياري)",
    display_committee: "اللجنة (اختيارية)",
    display_none: "بدون",
    no_display_members: "لا يوجد أعضاء للعرض بعد.",
    save_btn: "حفظ",
    add_btn: "إضافة / نشر",
    delete_btn: "حذف",
    ...
    news_media_url: "أو الصق رابطاً خارجياً (يوتيوب مثلاً)",
    event_link_label: "رابط تفاصيل الفعالية (اختياري)",
    upload_media: "رفع ملف من جهازك",
    choose_file: "اختيار ملف",
    uploading: "جاري الرفع…",
    upload_preview: "معاينة الوسائط",
    remove_media: "إزالة الوسائط",
    upload_failed: "تعذّر رفع الملف. حاول مرة أخرى.",
    upload_too_large: "حجم الملف أكبر من الحد المسموح:",
    upload_bad_type: "نوع الملف غير مدعوم. المسموح:",
    upload_hint_image: "JPG أو PNG أو WEBP",
    upload_hint_video: "MP4 أو WEBM",
    ...
    confirm_delete_news: "حذف هذا الخبر نهائياً؟ سيُحذف معه الملف المرفوع إن لم يكن مستخدماً في خبر آخر.",
    confirm_delete_event: "حذف هذه الفعالية نهائياً؟",
    confirm_delete_points: "حذف هذا السجل من جدول النقاط؟",
    confirm_delete_display: "حذف هذا العضو من العرض نهائياً؟",
  ...
  en: {
    ...
    admin_display: "Listed Members",
    display_member_lead:
      "People shown in the club structure and leaderboard without a login account.",
    display_badge: "Role (optional)",
    display_committee: "Committee (optional)",
    display_none: "None",
    no_display_members: "No listed members yet.",
    save_btn: "Save",
    admin_news: "News",
    admin_points: "Points",
    admin_events: "Events",
    ...
    news_media_url: "Or paste an external link (e.g. YouTube)",
    event_link_label: "Event details link (optional)",
    upload_media: "Upload a file from your device",
    choose_file: "Choose file",
    uploading: "Uploading…",
    upload_preview: "Media preview",
    remove_media: "Remove media",
    upload_failed: "Upload failed. Please try again.",
    upload_too_large: "File is larger than the limit:",
    upload_bad_type: "Unsupported file type. Allowed:",
    upload_hint_image: "JPG, PNG or WEBP",
    upload_hint_video: "MP4 or WEBM",
    ...
    confirm_delete_news: "Delete this news item permanently? Its uploaded file goes too, unless another item still uses it.",
    confirm_delete_event: "Delete this event permanently?",
    confirm_delete_points: "Remove this row from the leaderboard?",
    confirm_delete_display: "Remove this listed member permanently?",
